                        ...
                        <div className="row">
                            <div className="col-md-8">
                                <section>
                                    ...
                                    <p className="text-justify">The environmental industry, otherwise known as the "eco-industry" as the name suggests,
                                    is related to environmental
                                    wellbeing and protection. There are two major sub-sectors in the environmental industry,
                                    pollution management and
                                        resource management.</p>
                                    <p className="text-justify">The environmental industry is referred to as the ones that have been producing marketable
                                    ...
                                    technologies to assist in
                                        environmental growth.</p>
                                    <p className="text-justify">The environmental industry is policy-based and corporate, and environmental governance is
                                    ...
                                    environmental degradation, the industry has also come to light to the people with its
                                    ...
                                    <p className="text-justify">A major use of technology in the environmental industry is seen in the field of air
